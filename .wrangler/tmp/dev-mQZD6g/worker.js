...
// .wrangler/tmp/bundle-ygLEII/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-ygLEII/middleware-insertion-facade.js
init_modules_watch_stub();
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (request.method === "GET" && url.pathname === "/") {
        const homepage = host === "www.ubanihosting.co.za" ? renderDesignerLanding(getCanonicalApiOrigin(request, env)) : renderFrontend(url.pathname, getCanonicalApiOrigin(request, env));
